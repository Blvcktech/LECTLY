    ...
    <div className="min-h-screen bg-[#F7F4EE]">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-[15px] text-[#4a4540] leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>4. Third-Party AI Processing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>5. Data Storage and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>6. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>8. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>9. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1815] mb-3" style={{ fontFamily: "'Georgia', serif" }}>10. Contact Us</h2>
            <p>
