    ...
    <div className="min-h-screen bg-cream">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12">
        <div className="flex items-center gap-3 mb-2">
          <Shield className="w-6 h-6 text-ink-m" />
        ...
        <div className="space-y-8 text-[15px] text-sub leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>2. Information We Collect</h2>
            <p className="font-semibold text-ink mt-4 mb-2">Account Information</p>
            <p>
            ...
            <p className="font-semibold text-ink mt-4 mb-2">Lecture Content</p>
            <p>
            ...
            <p className="font-semibold text-ink mt-4 mb-2">Usage Data</p>
            <p>
            ...
            <p className="font-semibold text-ink mt-4 mb-2">Technical Data</p>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>4. Third-Party AI Processing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>5. Data Storage and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>6. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>8. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>9. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3" style={{ fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>10. Contact Us</h2>
            <p>
